...
CREATE TABLE `KhaltiPayment` (
    ...
    UNIQUE INDEX `KhaltiPayment_transactionId_key`(`transactionId`),
    INDEX `KhaltiPayment_courseId_idx`(`courseId`),
    UNIQUE INDEX `KhaltiPayment_customerId_courseId_key`(`customerId`, `courseId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
